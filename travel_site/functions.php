<?php
/**
 * TravelSite functions and definitions
 *
...
function travel_site_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'travel_site_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'travel_site_setup' );
 ...
 */
function travel_site_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'travel_site_content_width', 640 );
}
add_action( 'after_setup_theme', 'travel_site_content_width', 0 );
...
add_action( 'widgets_init', 'travel_site_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'travel_site_scripts' );
